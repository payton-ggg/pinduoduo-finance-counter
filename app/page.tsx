  ...
  const mapped: ProductUI[] = data.map((p: any) => {
    ...
    return {
      ...
      variantsList: variants.filter((v: any) => v.isIncluded !== false).map((v: any) => ({
        ...
        priceInUA: v.priceInUA !== null && v.priceInUA !== undefined ? Number(v.priceInUA) : null,
        netPrice: v.netPrice !== null && v.netPrice !== undefined ? Number(v.netPrice) : null,
        rateCNY: v.rateCNY ?? null,
        rateUSD: v.rateUSD ?? null,
        purchasedCount: v.purchasedCount !== null && v.purchasedCount !== undefined ? Number(v.purchasedCount) : 0,
        sellsCount: v.sellsCount !== null && v.sellsCount !== undefined ? Number(v.sellsCount) : 0,
        shippingUA: v.shippingUA !== null && v.shippingUA !== undefined ? Number(v.shippingUA) : null,
        managementUAH: v.managementUAH !== null && v.managementUAH !== undefined ? Number(v.managementUAH) : null,
